...
class ProfilePage extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      flights: [], billLS: [], billLY: [], billCustom: [], totalLS: 0, totalLY: 0, totalCus: 0,
    }
  }
  ...
  async fetchData(values) {
    ...
    if (values.queryType === 'flights') {
      ...
      this.setState({
        billLS: billLM, billLY, totalLS: totalLM, totalLY,
      })
      ...
      this.setState({ billCus, totalCus })
      ReactDOM.render(
        (
          <div>
      ...
      <Layout style={{ minHeight: '100%', maxWidth: '100%' }}>
        ...
        <div style={{ padding: '0 100px' }}>
          ...
          >
                ...
                <Col span={24}>
                  ...
                  >
                    <Row
                      gutter={{
                            xs: 8, sm: 16, md: 24, lg: 32,
                          }} justify="space-between" style={{ padding: '10px 0', width: '100%', margin: '0' }}
                    >
                      <Col span={8}>
                            <Form.Item
                                name="startDate"
            ...
            <Footer style={{
              padding: '24px 0', position: 'relative', bottom: '0', width: '100%',
            }}
            >
