...
import {
  Layout, Breadcrumb, Row, Col, Button, Input, Form,
} from 'antd'
import {
  UserOutlined, EyeInvisibleOutlined, EyeTwoTone, LockOutlined,
                  ...
                  <div id="loginInfoWrapper">
                    ...
                    <Row>
                      <p style={{ fontSize: '1.1rem' }}>
                        Please sign in with your AirTraveller account.
                        <br />
                      ...
                      <Row style={{ marginTop: '10px' }}>
                        <Form.Item style={{ width: '100%', margin: '0' }}>
                          <Button
                            ...
                            htmlType="submit"
                            style={{
                              margin: 'auto', width: '100%', height: '45px', fontSize: '1.1rem',
                            }}
                          >
                            Login
                          </Button>
...
export function LoginRouter({ match }) {
  return (
    <Route>
      <Switch>
